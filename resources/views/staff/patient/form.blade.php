    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h2>@lang($client->exists ? 'site.client-edit' : 'site.client-create', ['name' => $client->name])
                </h2>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">@lang('site.client-edit')</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body ">
                        <form action="{{ route('staff.client.save', $client) }}" method="POST"
                        enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        old('national_id')?? $client->national_id}}">
                                        @error('national_id')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        old('age')?? $client->age}}" min="1" max="100">
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="city_id" id="city" class="form-control">
                                            @php $CityId = old('city_id') ?? $user->staff->city_id ?? 0 @endphp
                                            @if($cities)
                                            @foreach ($cities as $id => $city)
                                            <option value="{{ $id }} " {{($client->city_id===$id) ?'selected' : null}}>
                                                {{ $city }}
                                            </option>
                                            @endforeach
                                            @endif
                            ...
                            <input type="checkbox" name="emergency" value="1" {{ $client->emergency== 1
                            ? 'checked' : 0 }}>
